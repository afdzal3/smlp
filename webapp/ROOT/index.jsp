<%@ page contentType="text/html;charset=UTF-8" %>
    <% String nonce=java.util.UUID.randomUUID().toString(); response.setHeader("X-Frame-Options", "DENY" );
        response.setHeader("X-Content-Type-Options", "nosniff" );
        response.setHeader("Content-Security-Policy", "default-src 'self'; script-src 'self' 'nonce-" + nonce
        + "' https://www.googletagmanager.com; style-src 'self' 'nonce-" + nonce
        ...
        <%@ include file="var.jsp" %>
            ...
            <head>
                ...
                <link href="/bootstrap.css" rel="stylesheet" nonce="<%= nonce %>">
                <link href="/iris3.css" rel="stylesheet" nonce="<%= nonce %>">
                        ...
                        <div class="col-md-7 col-sm-12 leftDiv ">
                            <div class="row">
                                <div class="col-12 align-items-center text-center mt-4">
                                    <h4 class="mt-1 fs-4 fw-bold">INTEGRATED REQUISITION & INTERACTIVE SERVICE DESK
                                    </h4>
                                </div>
                            </div><!-- /row-->
                            <div class="row m-2">
                            ...
                            <div class="row text-center float-center m-0">
                                ...
                                <div class="card col-md-4">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-6 card-body">
                                            <a href="<%= ssUrl %>"
                                                class="btn btn-outline-secondary w-100 m-0 border-0 ">
                                                SELF SERVICE (SS)
                                            </a>
                                        </div>
                                    </div><!--inner row-->
