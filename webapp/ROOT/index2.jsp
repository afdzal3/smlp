...
<body>
    <%@ include file="var.jsp" %>
        ...
        <div class="container-xl">
            ...
            <img src="/images/GITD-Rework.png" alt="Bottom Right" class="position-fixed bottom-0 right-0"
                style="width: 99px; height: 51px;">
                        ...
                        <div class="wrapper">
                            <div class="container">
                                ...
                                <div class="content">
                                    <div class="card">
                                        <a href="<%= spUrl %>">
                                            <img src="/images/SP-icon.png" alt="Service Portal" class="card-img-top">
                                            <div class="card-body">
                                    ...
                                    <div class="card">
                                        <a href="<%= smUrl %>">
                                            <img src="/images/SM-icon.png" alt="Service Manager" class="card-img-top">
                                            <div class="card-body">
                            ...
                            <div class="footer">
                                ...
                                <a target="_blank" href="/images/Contact_Us_v5.pdf" class="btn btn-link">CONTACT US</a>
                            </div>
                        </div>
                        <!-- IRIS 3 ENDS -->
        </div>
